        ...
        return (
            <div>
                ...
                <div className="d-flex">
                    ...
                    <button className="btn btn-danger my-2 my-sm-0 wbdv-nav-add"
                            onClick={this.props.addCourse} type="submit"
                            style={{"border-radius": "50%"}}>
                        <i className="fas fa-plus fa-sm wbdv-nav-plus"/></button>
                </div>

                <button className="btn btn-danger my-2 my-sm-0 wbdv-nav-add fa-2x"
                        onClick={this.props.addCourse} id="fixedbutton" style={{
                    "position": "fixed",
                    "bottom": "50px",
                    "right": "50px",
                    "border-radius": "50%"
